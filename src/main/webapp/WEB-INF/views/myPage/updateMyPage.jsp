...
<body>
	...
	<%@ include file="/WEB-INF/views/include/sideBar.jsp"%>
		...
		<div>
			<h2>회원정보수정</h2>
			<form action="/myPage/updateMyPage" method="post" id="updateMyPage_form">
				<section class="section_left">
					...
					<div class="email_wrap">
						<div class="email_name">
							이메일 : <input class="email_input" name="email" value="${member.email}">
						</div>
					...
					<div class="address_wrap">
						<div class="post_input_wrap">
							<div class="post_name">
								우편번호 : <input class="post_input" name="post" value="${member.post}" readonly="readonly">
							</div>
							<div class="address_name">
								주소 : <input type="button" class="address_btn" value="주소 찾기" onclick="execution_daum_address()">
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="addr1_input_wrap">
							<div class="addr1_input_box">
								<input class="addr1_input" name="addr1" value="${member.addr1}" readonly="readonly">
							</div>
						</div>
						<div class="addr2_input_wrap">
							<div class="addr2_input_box">
								<input class="addr2_input" name="addr2" value="${member.addr2}" readonly="readonly">
							</div>
					...
					<div class="change_pw_wrap">
						<div class="change_pw_name">
							...
							<div class="current_pw_input_box">
								현재 비밀번호 : <input type="password" class="current_pw_input" name="current_pw">
							</div>
							...
							<div class="new_pw_input_box">
								새로운 비밀번호 : <input type="password" class="new_pw_input" name="pw">
							</div>
							<div class="new_pwck_input_box">
								새로운 비밀번호 확인: <input type="password" class="new_pwck_input">
							</div>
...
<script>
		...
		$(".confirm_btn").click(function(){
			...
			/* 최종 유효성 검사 */
			if(telCheck&&emailCheck&&addrCheck){
				alert("회원 정보 수정 완료");
