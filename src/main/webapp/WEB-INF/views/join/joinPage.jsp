...
<body>
	...
	<div class="content_area">
		...
		<form id="join_form" method="post">
			...
			<!-- 회원가입 부분 -->
			<span class="join_wrap_name">회원가입</span>
			<div class="join_wrap">
				...
				<div class="pw_wrap">
					...
					<div class="pw_input_box"><input class="pw_input" name="pw" type="password"></div>
					<span class="final_pw_ck">비밀번호를 입력해주세요.</span>
				</div>
				<!-- 비밀번호 확인 -->
				<div class="pwck_wrap">
					<div class="pwck_name">비밀번호 확인</div>
					<div class="pwck_input_box"><input class="pwck_input" type="password"></div>
				...
				<div class="birth_wrap">
					...
					<div class="birth_input_box"><input class="birth_input" name="birth" placeholder="ex)2001/01/01"></div>
				...
				<div class="tel_wrap">
					...
					<div class="tel_input_box"><input class="tel_input" name="tel" placeholder="예) 01012345678"></div>
				</div>
	...
	<script>
		...
		$(document).ready(function(){
			...
			$(".join_button").click(function(){
				...
				/* 최종 유효성 검사 */
				if(idCheck&&pwCheck&&pwckCheck&&nameCheck&&emailCheck&&emailnumCheck&&birthCheck&&addrCheck&&telCheck){
					alert("회원가입");
