...
--%>
	...
	<div align="center">
		<h1>비밀번호 확인</h1>
		<form action="/myPage/secessionConfirm" method="post" id="secession_form">
			<input type="hidden" name="id" value="${member.id}">
			<table style="width: 80%">
				<tr>
					<th>${member.id}의 ${member.name}님 탈퇴하시겠습니까?</th>
				</tr>
				<tr>
					<th>비밀번호</th>
					<td><input name="pw" size="20" placeholder="비밀번호를 입력해주세요."></td>
				</tr>
				<tr>
					<th>확인문자</th>
				</tr>
